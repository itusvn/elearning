# Generated by Django 3.2.15 on 2022-10-05 10:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='quiz.myuser')),
                ('score', models.IntegerField(default=0)),
                ('interests', models.ManyToManyField(related_name='interested_students', to='quiz.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
            fields=[
                ...
                ('question_type', models.TextField(verbose_name='Question Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correct', models.TextField(max_length=255, verbose_name='Correct answer')),
